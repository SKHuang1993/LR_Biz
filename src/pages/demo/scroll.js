...
class Marquee extends Component {
    ...
    _startAnimation() {
        ...
        console.log(4444, this.state.scrollWidth)
        Animated.sequence([
            ...
            .start(() => {
                // 无缝切换
                console.log(9090,this.state.scrollXValue - this.state.scrollWidth === -this.state.scrollContentOffsetX);
                console.log(8989,`${this.state.scrollXValue} ++ ${this.state.scrollWidth} ++ ${this.state.scrollContentOffsetX}`)
...
export default class Index extends Component {
    ...
    render() {
        ...
        console.log(223, this.state.data)
        return (
            <View style={{ height: 30, overflow: 'hidden', backgroundColor: 'red' }}>
                <Marquee
                ...
                //  duration={10000}
                //  scrollWidth={500}
                // scrollStyle={{ backgroundColor: 'transparent',height:30 }}
