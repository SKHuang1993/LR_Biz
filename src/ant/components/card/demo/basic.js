...
export default class BasicCardExample extends React.Component {
    render() {
        ...
        <WingBlank size="lg">
          <Card>
            <Card.Header title="这是 title" thumbStyle={{ width: 30, height: 30 }} thumb="http://gravatar.com/avatar/e9c13fb979736b16033acbce4c710ca1.png?size=32" extra="this is extra"/>
            <Card.Body>
