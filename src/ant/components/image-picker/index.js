...
export default class ImagePicker extends React.Component {
    ...
    render() {
        ...
        {files.map((item, index) => (<View key={index} style={[styles.item, styles.size]}>
        ...
        <TouchableWithoutFeedback onPress={this.showPicker} onPressIn={this.onPressIn} onPressOut={this.onPressOut}>
          <View ref={conponent => this.plusWrap = conponent} style={[styles.item, styles.size, styles.plusWrap, styles.plusWrapNormal]}>
            <Text style={[styles.plusNormal, styles.plusText]}>+</Text>
          </View>
        </TouchableWithoutFeedback>

        {this.state.visible ? (<ImageRoll onCancel={this.hideImageRoll} onSelected={imgObj => this.addImage(imgObj)}/>) : null}
      </View>);
    }
}
