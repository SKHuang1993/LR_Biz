...
export default class TextAreaItem extends React.Component {
    ...
    render() {
        ...
        const { value, defaultValue, rows, error, clear, count, autoHeight, last, onErrorClick, styles, } = this.props;
        let valueProps;
        ...
        return (<View style={[styles.container, containerStyle, { position: 'relative' }]}>
