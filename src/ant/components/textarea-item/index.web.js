...
export default class TextareaItem extends React.Component {
    ...
    render() {
        let { prefixCls, prefixListCls, style, title, value, defaultValue, clear, rows, count, editable, disabled, error, className, labelNumber, autoHeight } = this.props;
        ...
        <div className={`${prefixCls}-control`}>
          <textarea ref="textarea" maxLength={count} {...otherProps} {...valueProps} onChange={this.onChange} onBlur={this.onBlur} onFocus={this.onFocus} readOnly={!editable}/>
        </div>
