...
class ListItem extends React.Component {
    render() {
        const [{ prefixCls, className, activeStyle, error, align, wrap, disabled, children, multipleLine, thumb, extra, arrow, }, restProps] = splitObject(this.props, ['prefixCls', 'className', 'activeStyle', 'error', 'align', 'wrap', 'disabled',
        ...
        const content = <div {...restProps} className={classNames(wrapCls)}>
      ...
      <div className={lineCls}>
        ...
        return (<Touchable disabled={disabled || !restProps.onClick} activeStyle={activeStyle} activeClassName={`${prefixCls}-item-active`}>
        {content}
      </Touchable>);
    }
}
