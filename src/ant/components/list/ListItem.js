...
export default class Item extends React.Component {
    render() {
        const { styles = listItemStyles, children, multipleLine, thumb, extra, arrow = '', style, onClick, onPressIn = noop, onPressOut = noop, wrap, disabled, align, } = this.props;
        let numberOfLines = {};
        if (wrap === false) {
            numberOfLines = {
                numberOfLines: 1,
        ...
        if (Array.isArray(children)) {
            ...
            if (React.isValidElement(children)) {
                ...
                contentDom = (<View style={[styles.column]}>
        ...
        return (<TouchableHighlight {...underlayColor} onPress={onClick ? onClick : undefined} onPressIn={onPressIn} onPressOut={onPressOut}>
        {itemView}
      </TouchableHighlight>);
    }
}
