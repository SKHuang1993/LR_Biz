...
const Carousel = React.createClass({
    ...
    loopJump() {
        ...
        if (this.state.loopJump && Platform.OS === 'android') {
            ...
            setTimeout(() => {
                ...
                this.refs.scrollview.scrollTo({ x, y: 0 }, false);
            }, 10);
        }
    },
    autoplay() {
    ...
    renderDots(index) {
        ...
        const count = children ? children.length || 1 : 0;
        return (<Pagination style={[styles.pagination, styles[positionStyle]]} indicatorStyle={{ flexDirection }} current={index} mode="pointer" total={count}/>);
    },
    onLayout(e) {
