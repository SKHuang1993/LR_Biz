...
export default class BasicModalExample extends React.Component {
    ...
    render() {
        return (<View style={{ paddingTop: 30, marginTop: 64 }}>
        <WingBlank>
        ...
        <Modal transparent={false} visible={this.state.visible2} animationType="slide-up">
        ...
        <Modal title="测试" transparent onClose={this.onClose} maskClosable visible={this.state.visible} closable footer={[
