...
export default class MIndexedList extends React.Component {
    render() {
        ...
        return (<IndexedList ref="indexedList" sectionHeaderClassName={`${prefixCls}-section-header ${listPrefixCls}-body`} sectionBodyClassName={`${prefixCls}-section-body ${listPrefixCls}-body`} {...restProps} {...extraProps}>{this.props.children}</IndexedList>);
    }
}
