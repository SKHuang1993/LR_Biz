...
export default class InputToolbar extends React.Component {
        ...
        return <View style={[styles.emojiRow]}>
            ...
            >
                <View style={styles.slide}>
                    <Image resizeMode={'cover'} style={styles.emojiBg} source={require('./emoji/1.png')} >
                ...
                <View style={styles.slide}>
                    <Image style={styles.emojiBg} source={require('./emoji/2.png')} >
                        <View style={styles.slideRow}>
                ...
                <View style={styles.slide}>
                    <Image style={styles.emojiBg} source={require('./emoji/3.png')} >
                        <View style={styles.slideRow}>
                ...
                <View style={styles.slide}>
                    <Image style={styles.emojiBg} source={require('./emoji/4.png')} >
                        <View style={styles.slideRow}>
                ...
                {/* 表情一共89个，最后一栏特殊处理 */}
                <View style={styles.slide}>
                    <Image style={styles.emojiBg} source={require('./emoji/5.png')} >
                        <View style={styles.slideRow}>
                ...
                <View style={styles.searchRow}>
                    <TextInput ref={"txtInput"}
                            ...
                            if (this.props.onBlur) {
                               ...
                               blurOnSubmit={false}
                               onSubmitEditing={() => {
                            if (this.props.onSubmitEditing && this.props.value.length > 0) {
    ...
    renderEmojiButton() {
        ...
        return (
            <TouchableOpacity activeOpacity={.7} style={[styles.iconButonWrap]}
                ...
                {
                    isEmoji ? <Icon style={styles.iconButton} icon="0xe152" />     :
                        <Icon style={styles.iconButton} icon="0xe130" />
                }
            </TouchableOpacity>
        )
    }
    ...
    renderSendButton() {
        ...
        return <TouchableOpacity activeOpacity={.7} style={styles.iconButonWrap} keyboardShouldPersistTaps='always'
            ...
            <Icon style={styles.iconButton} icon={'0xe121'} />
        </TouchableOpacity>
    }
