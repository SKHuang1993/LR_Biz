    ...
    render(){
        ...
        return(
                ...
                <View style={styles.page}>
                    ...
                    <View style={{position:'absolute',top:0,left:0,width:window.width}}>
                    <NavBar navigator={this.props.navigator} title={this.props.Title}
                        leftIcon={'0xe183'} rightIcon={'0xe6da'}
                        onLeftClick={()=>{this.props.navigator.pop();}} 
                        onRightClick={() => {this.toShare()}}
                    />
                    </View>
    ...
    toShare = () =>{
        ...
        Popup.show(
            <View style={{paddingBottom:isIphoneX()?24:0}}>
                <View style={{flexDirection:'row',width:window.width,backgroundColor:'#fff',paddingTop:10,alignItems:'center'}}>
                        <TouchableOpacity style={{alignItems:'center',flex:1}} 
                            onPress={()=>{this.shareToPlatform(1)}}>
                            <Icon icon={'0xe6d6'} color={'#6DD144'} style={{fontSize: 45,flex:1}}/>
                            <Text style={{fontSize:13,color:'#333',marginBottom:5}}>{'微信'}</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={{alignItems:'center',flex:1}}
                    ...
                    <View style={{width:window.width,height:1,backgroundColor:'#ebebeb'}}/>
                    <TouchableOpacity style={{height:44,width:window.width,justifyContent:'center',alignItems:'center'}}
                        onPress={()=>{Popup.hide();}}>
                        <Text style={{color:COLORS.btnBg,fontSize:15}}>{'取消'}</Text>
                    </TouchableOpacity>
            </View>
