...
export default class Modal extends React.Component {
    ...
    renderFooterButton(button, prefixCls, i) {
        ...
        return (<Touchable activeClassName={`${prefixCls}-button-active`} key={i}>
    ...
    render() {
        const { prefixCls, className, transparent, animated, transitionName, maskTransitionName, style, footer = [], } = this.props;
      ...
      {footer.map((button, i) => this.renderFooterButton(button, prefixCls, i))}
        ...
        return (<Dialog prefixCls={prefixCls} className={wrapCls} transitionName={anim} maskTransitionName={maskAnim} style={rootStyle} footer={footerDom} wrapProps={wrapProps} {...restProps}/>);
    }
}
Modal.defaultProps = {
    prefixCls: 'am-modal',
