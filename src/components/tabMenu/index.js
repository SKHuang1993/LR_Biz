    ...
    render () {
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={[styles.row, styles.flex_1, { backgroundColor: 'red' }]}>
        ...
        for (var i in data) {
            if (index === tabSelected) {
                for (var k in data[i]) {
                    ...
                    leftPannel.push(
                        <Text key={k} onPress={this.leftPress.bind(this, i, k)}
                ...
                for (var k in data[i]) {
                    if (this.state[prefixType + i + '_' + k]) {
                        for (var j in data[i][k]) {
                            rightPannel.push(
                                <Text key={j} onPress={this.props.click.bind(this, data[i][k][j])} style={styles.left_row}>{data[i][k][j]}</Text>);
                        }
                        break;
                    }
                }
